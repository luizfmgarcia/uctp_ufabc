...
#==============================================================================================================            
    ...
    def start(self, solutionsNoPop, subj, prof, init):        
        if(prt==1): print "Creating first generation...",
        n = 0
        while(n!=init):
            candidate = Candidate()
...
#==============================================================================================================            
    ...
    def twoPop(self, solutionsNoPop, solI, solF, prof, subj, weights):
        ...
        if(prt==1): print "Checked feasibility,",
...
#==============================================================================================================            
    ...
    def calcFit(self, infeasibles, feasibles, prof, subj, weights):
        ...
        if(prt==1): print "Fitness of all Inf.,",
        ...
        if(prt==1): print "Fitness of all Feas.,",
